...
- New counters `externaldns_webhook_opnsense_lost_writes_total{provider,operation}` (`create`, `update`, `delete`) and `externaldns_webhook_opnsense_verify_reads_failed_total{provider}`, pre-created at zero.
